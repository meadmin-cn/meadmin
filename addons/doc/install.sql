...
CREATE TABLE aon_doc (
    ...
    icon_file_id character varying(20),
    type smallint NOT NULL,
    status smallint DEFAULT 1 NOT NULL,
    order_num smallint DEFAULT 0 NOT NULL,
    md_content text DEFAULT ''::text,
...
ALTER TABLE ONLY aon_doc_config
    ADD CONSTRAINT aon_doc_config_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY aon_doc
    ADD CONSTRAINT aon_doc_pkey PRIMARY KEY (id);
