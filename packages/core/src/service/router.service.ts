 ...
 */
import { ControllerOption } from '@midwayjs/core';
...
export class RouterService {
  ...
  protected mergeControllerOption(controllerOption: ControllerOption, controllerClz: Record<string, unknown>):ControllerOption {
