 ...
 */
import { CONTROLLER_KEY, ControllerOption, getClassMetadata, listModule, Provide, Scope, ScopeEnum } from '@midwayjs/core';
...
export class RouterService {
  ...
  protected mergeControllerOption(controllerOption: ControllerOption, controllerClz: Record<string, unknown>) {
  ...
  public initControllerOption() {
    ...
    for (const module of controllerModules) {
      this.mergeControllerOption(getClassMetadata(CONTROLLER_KEY, module), module);
    }
  }
}
