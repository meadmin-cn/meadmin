...
export class SystemMenuQueryDto extends IntersectionType(
  PageDto,
  PartialType(
    OmitDtoType(
      SystemMenu as new () => InferAttributesLoose<SystemMenu>,
      ['parent', 'roles', 'createdAdmin', 'updatedAdmin'], //移除关联字段和虚拟属性
    ),
  ),
) {
