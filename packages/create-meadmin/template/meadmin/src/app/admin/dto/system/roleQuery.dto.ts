...
export class SystemRoleQueryDto extends IntersectionType(
  PageDto,
  PartialType(
    OmitDtoType(
      SystemRole as new () => InferAttributesLoose<SystemRole>,
      ['menus', 'parent', 'admins', 'createdAdmin', 'updatedAdmin'], //移除关联字段和虚拟属性
    ),
  ),
) {
