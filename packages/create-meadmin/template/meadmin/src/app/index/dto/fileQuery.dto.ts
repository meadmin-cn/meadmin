...
export class FileQueryDto extends IntersectionType(PageDto, PartialType(
  OmitDtoType(
  UserFile as new () => InferAttributesLoose<UserFile>,
  ['url','createdUser','updatedUser','createdAdmin','updatedAdmin','avatarUsers'] //移除关联字段和虚拟属性
)
)) {
