...
export class RegistreDecorators {
  ...
  regitserDecorators: RegistreDecorator[] = [new SequelizeRegistreDecorators(), new IndexPermissionRegistreDecorators(), new AdminPermissionRegistreDecorators(), new TransactionRegistreDecorators()];
  /**
   * 对象初始化时自动执行的方法
   * @returns
   */
