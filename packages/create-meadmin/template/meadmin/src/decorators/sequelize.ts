...
export function InjectRepository(modelKey: { new (): Model<any, any> }, connectionName?: string) {
...
export class SequelizeRegistreDecorators implements RegistreDecorator {
  ...
  async onReady(container: IMidwayContainer) {
    this.dataSourceManager = await container.getAsync(SequelizeDataSourceManagerService);
  }
