...
export class SystemMenuUpdateDto extends PartialType(OmitDtoType(SystemMenu as new () => InferAttributesLoose<SystemMenu>, ['id', 'createdAt', 'updatedAt', 'createdAdminId', 'updatedAdminId'])) {
  //排除自动创建的字段
}
