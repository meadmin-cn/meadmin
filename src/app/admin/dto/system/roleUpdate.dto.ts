...
export class SystemRoleUpdateDto extends PartialType(OmitDtoType(SystemRole as new () => InferAttributesLoose<SystemRole>, ['menus', 'id', 'createdAt', 'updatedAt', 'createdAdminId', 'updatedAdminId'])) {
  //排除自动创建的字段
